...
- Fix built two ways, both keeping the *system* Mesa install untouched — an
  ...
  [`../extras/waydroid/fetch-old-mesa.sh`](../extras/waydroid/fetch-old-mesa.sh):
...
`scale: 2` → logical 960x600 (matches `extras/device/desktop-fix.sh`'s own
...
- Installed Android apps' `.desktop` launchers
  ...
  **Automated fix**: [`../extras/waydroid/waydroid-fix-desktop-entries`](../extras/waydroid/waydroid-fix-desktop-entries)
  (flips `NoDisplay`, refreshes the desktop-entry cache, idempotent),
  triggered by a systemd user path unit
  ([`../extras/waydroid/systemd/`](../extras/waydroid/systemd/), inotify-watches
...
- `/opt/waydroid-work/old-mesa/` (168MB, extracted Mesa 25.0.7) and
  ...
  [`../extras/waydroid/fetch-old-mesa.sh`](../extras/waydroid/fetch-old-mesa.sh). Backup
...
- `~/waydroid-work-backup/patched-services/` — the patched `services.jar`
  ...
  [`../extras/waydroid/patch-services-jar.sh`](../extras/waydroid/patch-services-jar.sh).
...
**The patch** ([`../extras/waydroid/patches/LaunchParamsUtil-freeform-divzero.diff`](../extras/waydroid/patches/LaunchParamsUtil-freeform-divzero.diff)):
...
and reassembled. [`../extras/waydroid/patch-services-jar.sh`](../extras/waydroid/patch-services-jar.sh)
...
[`../extras/device/waydroid-install-framework-overlay.sh`](../extras/device/waydroid-install-framework-overlay.sh)
